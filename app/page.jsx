...
export default function HomePage() {
  ...
  // Listen for custom event to open donate modal from other pages (e.g. Market page)
  useEffect(() => {
    const handleOpenDonate = () => setDonateOpen(true);
    window.addEventListener('openDonateModal', handleOpenDonate);
    return () => window.removeEventListener('openDonateModal', handleOpenDonate);
  }, []);
    ...
    <div className="container content">
      ...
      <div className="navbar glass">
        ...
        <div className="nav-links" style={{ position: 'absolute', left: '50%', transform: 'translateX(-50%)', display: 'flex', gap: '20px', alignItems: 'center' }}>
            <a href="/" style={{ color: 'var(--primary)', fontWeight: 'bold', textDecoration: 'none' }}>基金</a>
            <a href="/market" style={{ color: 'var(--muted)', textDecoration: 'none' }}>行情</a>
        </div>
